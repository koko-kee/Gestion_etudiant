  ...
  <div class="card">
    <div class="card-body">
      ...
      <?php if (isset($params['teacher'])):?>
        ...
        <form action="/Gestion/professeur/edit/<?=$params['teacher']->IPD?>" method="post" class="forms-sample">
      <?php else : ?>
        <h1 style="text-align:center">Nouveau Professeur</h1>
      ...
      <?php endif;?>
        ...
        <div class="form-group">
          ...
          <input name="Grade" type="text" class="form-control <?php echo isset($_SESSION['message']['Grade']) ? 'is-invalid' : ''; ?>" value="<?php echo isset($params['teacher']->Grade) ? $params['teacher']->Grade : ''; ?>" id="exampleInputCity1" placeholder="Grade">
        ...
        <div class="form-group">
          ...
          <input type="number" name="Salaire" value="<?php echo isset($params['teacher']->Salaire) ? $params['teacher']->Salaire : ''; ?>" class="form-control <?php echo isset($_SESSION['message']['Salaire']) ? 'is-invalid' : ''; ?>" id="exampleInputCity1" placeholder="Salaire">
        ...
        <div class="form-group">
          ...
          <input type="number" value="<?php echo isset($params['teacher']->Prime) ? $params['teacher']->Prime : ''; ?>" name="Prime" class="form-control <?php echo isset($_SESSION['message']['Prime']) ? 'is-invalid' : ''; ?>" id="exampleInputCity1" placeholder="Prime">
