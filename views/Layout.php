        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#form-elements" aria-expanded="false" aria-controls="form-elements">
              ...
              <span class="menu-title">Gestion Professeurs</span>
              <i class="menu-arrow"></i>
            </a>
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#charts" aria-expanded="false" aria-controls="charts">
              ...
              <span class="menu-title">Gestion Departements</span>
              <i class="menu-arrow"></i>
            </a>
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#icons" aria-expanded="false" aria-controls="icons" >
              ...
              <span class="menu-title">Gestions Faculter</span>
              <i class="menu-arrow"></i>
            </a>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="auth">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="pages/samples/register.html">Utilisateurs</a></li>
              </ul>
            </div>
          </li>
        </ul>
